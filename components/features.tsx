...
export function Features() {
  ...
  return (
    <section id="como-funciona" className="pt-24 pb-10 px-4 sm:px-6 lg:px-8 overflow-visible">
          ...
          {FEATURE_KEYS.map((feat, index) => {
            ...
            return (
              <motion.div
                ...
                className="glass-effect hover-box p-6 sm:p-8 rounded-xl border border-blue-500/40 group min-h-[280px] flex flex-col"
              >
                ...
                <h3 className="hover-title text-xl font-semibold mb-3 leading-tight text-foreground">{t(feat.title)}</h3>
