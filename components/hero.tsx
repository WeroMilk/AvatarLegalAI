...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-28 sm:pt-32 pb-8">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-muted mb-8 md:mb-12 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-12 md:mb-16 px-4">
            <Link
              href="/como-funciona"
              className="hover-button w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-3.5 bg-white hover:bg-white/95 border border-border dark:border-transparent rounded-lg text-base sm:text-lg font-semibold text-center text-blue-600 hover:text-blue-700 shadow-sm"
            >
              {t("home_how_it_works")}
            </Link>
            <Link
              href="/documentos"
              className="hover-button btn-primary w-full sm:w-auto px-6 sm:px-8 py-2.5 sm:py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-base sm:text-lg font-semibold border-2 border-transparent text-center text-white"
            >
              {t("home_see_documents")}
            </Link>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 max-w-4xl mx-auto px-4 mt-16 md:mt-20">
            <motion.div
