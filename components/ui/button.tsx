    ...
    return (
      <button
        ...
        className={clsx(
          ...
          {
            "btn-primary bg-blue-600 hover:bg-blue-700 text-white glow-border": variant === "primary",
            "glass-effect border border-border hover:border-border text-foreground": variant === "secondary",
            "border border-border hover:border-blue-500/50 text-foreground": variant === "outline",
